            ...
            <div class="block">
                <div class="block-content">
		            ...
		            <table class="table table-hover table-borderless table-header-bg js-dataTable-full" id="account_list">
		                <thead>
		                    <tr>
		                        <th class="text-center"><?php echo $this->lang->line('tablename'); ?></th>
		                        <th class="text-center"><?php echo $this->lang->line('filename'); ?></th>
		                        <th class="text-center"><?php echo $this->lang->line('refresh'); ?></th>
		                    </tr>
		                </thead>
		                <tbody>
		                    <tr>
...
<script src="<?php echo $one->assets_folder; ?>/js/pages/datamanage.js"></script>
