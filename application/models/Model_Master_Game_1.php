<?php
class Model_Master_Game_1 extends MY_Model {
	public function __construct()
	{
		parent::__construct();
		$this->db = $this->load->database('master_game_1', TRUE);
	...
	public function itemlist( $player_id )
	{
		...
		$query .= "from tm_game.tb_item as a inner join tm_game.tb_player as b on a._player_id = b._player_id ";
